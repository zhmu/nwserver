...
mod tests {
    ...
    #[test]
    fn shuffle_1() {
        let key: [ u8; 32 ] = [ 0x12, 0x34, 0x56, 0x78, 0x9a, 0x7b, 0x44, 0x93, 0x98, 0x32, 0x35, 0x67, 0xdd, 0x2f, 0xaa, 0x80, 0xab, 0xdc, 0xb0, 0xc0, 0x1e, 0x21, 0x46, 0x34, 0x2f, 0x75, 0xfd, 0xb5, 0xb5, 0xde, 0xee, 0xd3 ];
        let expected: [ u8; 16 ] = [ 0x05, 0x01, 0xbd, 0xc4, 0xb0, 0x32, 0x6a, 0xba, 0x51, 0xfa, 0x81, 0x9f, 0x31, 0xea, 0x18, 0x78 ];
        let out = shuffle1(&key);
